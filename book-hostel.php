...
$uid=$_SESSION['login'];
				...
				if($rs)
				{ ?>
			<h3 style="color: green" align="center">You've Successfully Booked a Room in our Hostel!</h3>
			<div align="center">
...
<input type="radio" value="1" name="foodstatus"> With Food(Kshs 2000.00 Per Month Extra)
</div>
</div>	
